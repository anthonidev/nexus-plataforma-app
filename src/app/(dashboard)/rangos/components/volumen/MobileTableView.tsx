...
export function MobileTableView({ volumes, onViewDetail }: MobileTableViewProps) {
    if (!volumes.length) {
        return (
            <div className="flex flex-col items-center justify-center py-8 px-4 text-center text-muted-foreground border rounded-md bg-muted/5">
                ...
                <p>No se encontraron volúmenes mensuales</p>
    ...
    return (
        <div className="space-y-4">
            {volumes.map((volume) => {
                const startDate = volume.monthStartDate;
                const endDate = volume.monthEndDate
                                ...
                                <div className="p-4 space-y-3">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div className="flex flex-col">
                                            <DateFormatDisplay date={startDate} />
                                            <div className="flex items-center gap-1 text-xs text-muted-foreground">
                                                <span>al</span>
                                                <DateFormatDisplay date={endDate} />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div>
                                                <div className="text-xs text-muted-foreground">Directos Izq.</div>
                                                <div className="font-semibold text-blue-600 dark:text-blue-400">
                                                    {volume.leftDirects}
                                                </div>
                                            </div>
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div>
                                                <div className="text-xs text-muted-foreground">Directos Der.</div>
                                                <div className="font-semibold text-emerald-600 dark:text-emerald-400">
                                                    {volume.rightDirects}
                                                </div>
                                            </div>
                                    ...
                                    {volume.assignedRank && (
                                        <div className="flex items-center gap-2 mt-2 bg-amber-50 dark:bg-amber-900/10 p-2 rounded-md">
