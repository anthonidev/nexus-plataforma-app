...
export function ProductDetailError({ error, onBack, onRetry }: ProductDetailErrorProps) {
    return (
        <div className="container py-8">
            ...
            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-6 max-w-md mx-auto text-center">
                ...
                <p className="text-red-600 dark:text-red-400 mb-4">
                    {error ||
                        "No se pudo encontrar el producto solicitado o no está disponible en este momento."}
                </p>
