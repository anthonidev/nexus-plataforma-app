...
interface WithdrawalDetailErrorProps {
    error: string | null;
}

export function WithdrawalDetailError({ error }: WithdrawalDetailErrorProps) {
        ...
        <div className="container py-8">
            ...
            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-6 max-w-md mx-auto text-center">
                ...
                <p className="text-red-600 dark:text-red-400 mb-4">
                    {error || "No se pudo encontrar el retiro solicitado o no tienes permisos para verlo."}
                </p>
                <div className="flex flex-col sm:flex-row gap-2 justify-center">
                    ...
                    <Link href="/admin/retiros" passHref>
                        <Button>Volver a retiros</Button>
                    </Link>
                </div>
            </div>
        </div>
